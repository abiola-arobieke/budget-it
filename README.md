...
# 📖 [BUDGET-IT] <a name="about-project"></a>

**BUDGET-IT** is a a mobile web application where you can manage your budget: you have a list of transactions associated with a category, so that you can see how much money you spent and on what.
...
```sh
  git clone https://github.com/abiola-arobieke/budget-it.git
```
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/budget-it/issues).
